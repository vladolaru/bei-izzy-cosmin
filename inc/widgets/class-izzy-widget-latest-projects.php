...
/**
 * Core class used to implement a Latest Projects widget.
 *
 * @since 2.8.0
 *
 * @see WP_Widget
...
class izzy_Widget_Latest_Projects extends WP_Widget {
	...
	/**
	 * Sets up a new Latest Projects widget instance.
	 *
	 * @since 2.8.0
	 */
	public function __construct() {
		$widget_ops = array(
			...
			'description'                 => __( 'Your site&#8217;s latest Projects.', 'izzy' ),
	...
	public function widget( $args, $instance ) {
		...
		/**
		 * Filters the arguments for the Latest Projects widget.
		 *
		 * @since 3.4.0
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of posts to show:', 'izzy' ); ?></label>
        ...
        <p><input class="checkbox" type="checkbox"<?php checked( $show_date ); ?>
            ...
            <label for="<?php echo $this->get_field_id( 'show_date' ); ?>"><?php _e( 'Display post date?', 'izzy' ); ?></label>
        </p>
		<?php
	}
}
